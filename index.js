...
app.get("/generate-barcode", (req, res) => {
  ...
  bwipjs.toBuffer(
    ...
    (err, pngBuffer) => {
      ...
      const html = `
<html>
  <body style="font-family: Arial; display: flex; justify-content: center; align-items: center; padding: 0px;">
    <div style="border: 1px solid #000; padding: 0; text-align: center; width: 350px;">
