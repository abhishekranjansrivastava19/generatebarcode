...
<html>
  <body style="font-family: Arial; display: flex; justify-content: center; align-items: center; padding: 50px;">
    <div style="border: 1px solid #000; padding: 20px; text-align: center; width: 350px;">
      <div style="font-size: 2rem; font-weight: bold; margin-bottom: 4px;">${cls} (${section}) (${session})</div>
      <div style="font-size: 2rem; font-weight: bold; margin-bottom: 4px;">${name.toUpperCase()}</div>
      <div style="font-size: 2rem; margin-bottom: 10px;">S/o ${fatherName.toUpperCase()}</div>
